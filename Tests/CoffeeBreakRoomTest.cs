...
namespace Tests
{
    public class CoffeeBreakRoomTest
    {
        [Fact]
        public void Should_Create_A_CoffeeBreakRoom()
        {
            //Given
            ...
            //Then
            Assert.NotNull(newCoffeeBreakRoom);
        }

        [Fact]
        public void Should_Be_10_Vaccancy_In_CoffeeBreakRoom()
        {
            //Given
            var newCoffeeBreakRoom = new CoffeeBreakRoom("Room 1");
            newCoffeeBreakRoom.Capacity = 10;
            //When
            var capacity = newCoffeeBreakRoom.Capacity;
        ...
        [Fact]
        public void Should_Subscribe_9_Students_In_A_CoffeeBreakRoom()
        {
            //Given
            var newCoffeeBreakRoom = new CoffeeBreakRoom("Green");
            newCoffeeBreakRoom.Capacity = 10;
            newCoffeeBreakRoom.AddStudentsAtClassroom(
                new List<Student>()
                {
            ...
            //When
            var quantityOfStudents = newCoffeeBreakRoom.Students.Count;
        ...
        {
            //Given
            var newCoffeeBreakRoom = new CoffeeBreakRoom("Grey");
            newCoffeeBreakRoom.Capacity = 10;
